    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Annonce> options =
                new FirebaseRecyclerOptions.Builder<Annonce>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("annoncetun").orderByChild("user").equalTo(userlogged), Annonce.class)
                        .build();




        adapter2=new myadapter2(options,getApplicationContext());
